...
def test_parse_steps_with_comparisons():
    ...
    expected_suite = top.ProcedureSuite([
        top.Procedure('main', [
            ...
            top.ProcedureStep('6', top.StateChangeAction('vent_valve', 'closed'), [], 'PRIMARY')
        ])
    ])
...
def test_parse_from_file():
    ...
    expected_suite = top.ProcedureSuite([
        ...
        top.Procedure('abort_1', [
            ...
            top.ProcedureStep('2', top.StateChangeAction('remote_vent_valve', 'open'), [], 'PRIMARY')
        ]),
        top.Procedure('abort_2', [
            top.ProcedureStep('1', top.StateChangeAction('supply_valve', 'closed'), [
                (top.Immediate(), top.Transition('abort_2', '2'))
            ], 'PRIMARY'),
            top.ProcedureStep('2', top.StateChangeAction('line_vent_valve', 'open'), [], 'PRIMARY')
        ]),
    ])
...
def test_parse_steps_with_complex_comparisons():
    ...
    expected_suite = top.ProcedureSuite([
        top.Procedure('main', [
            ...
            top.ProcedureStep('7', top.StateChangeAction('vent_valve', 'closed'), [], 'PRIMARY')
        ])
    ])
...
def test_parse_logical_operator_forms():
    ...
    expected_suite = top.ProcedureSuite([
        top.Procedure('main', [
            ...
            top.ProcedureStep('7', top.StateChangeAction('vent_valve', 'open'), [], 'PRIMARY')
        ])
    ])
