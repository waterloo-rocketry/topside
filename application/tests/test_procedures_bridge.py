...
def test_proc_bridge_jump_to_step_normal():
    plumb_b = MockPlumbingBridge()
    proc_b = ProceduresBridge(plumb_b)
    ...
    procedure = top.Procedure('main', [
        ...
        top.ProcedureStep('3', top.StateChangeAction('vent_valve', 'closed'), [
...
def test_proc_bridge_jump_to_step_current_and_past():
    plumb_b = MockPlumbingBridge()
    proc_b = ProceduresBridge(plumb_b)
...
def test_proc_bridge_jump_to_step_invalid():
    plumb_b = MockPlumbingBridge()
    proc_b = ProceduresBridge(plumb_b)
